...
m_dll_export void update(s_platform_data* platform_data, void* game_memory, s_game_renderer* renderer, b8 is_last_update_this_frame)
{
	...
	if(!game->initialized) {
		...
		g_r->set_vsync(true);
		game->placeholder_texture = g_r->load_texture(renderer, "examples/test/assets/placeholder.png", e_filter_linear, e_wrap_clamp);
		game->base_texture = g_r->load_texture(renderer, "examples/test/assets/base.png", e_filter_linear, e_wrap_clamp);
		game->button_texture = g_r->load_texture(renderer, "examples/test/assets/button.png", e_filter_linear, e_wrap_clamp);
		game->tile_texture = g_r->load_texture(renderer, "examples/test/assets/tile.png", e_filter_linear, e_wrap_clamp);
		game->crater_texture = g_r->load_texture(renderer, "examples/test/assets/crater.png", e_filter_linear, e_wrap_clamp);
		game->rock_texture_arr[0] = g_r->load_texture(renderer, "examples/test/assets/rock01.png", e_filter_linear, e_wrap_clamp);
		game->rock_texture_arr[1] = g_r->load_texture(renderer, "examples/test/assets/rock02.png", e_filter_linear, e_wrap_clamp);
		game->broken_bot_texture = g_r->load_texture(renderer, "examples/test/assets/broken_bot.png", e_filter_linear, e_wrap_clamp);
		game->hotkey_texture = g_r->load_texture(renderer, "examples/test/assets/hotkey.png", e_filter_linear, e_wrap_clamp);

		game->upgrade_button_texture_arr[e_upgrade_buy_bot] = g_r->load_texture(renderer, "examples/test/assets/drone_icon.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_player_damage] = g_r->load_texture(renderer, "examples/test/assets/damage_icon.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_bot_damage] = g_r->load_texture(renderer, "examples/test/assets/drone_damage_icon.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_player_movement_speed] = g_r->load_texture(renderer, "examples/test/assets/speed_icon.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_bot_movement_speed] = g_r->load_texture(renderer, "examples/test/assets/drone_speed_icon.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_spawn_rate] = g_r->load_texture(renderer, "examples/test/assets/spawn_rate_icon.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_creature_tier] = g_r->load_texture(renderer, "examples/test/assets/creature_tier.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_player_harvest_range] = g_r->load_texture(renderer, "examples/test/assets/player_range_icon.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_bot_harvest_range] = g_r->load_texture(renderer, "examples/test/assets/drone_range_icon.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_double_harvest] = g_r->load_texture(renderer, "examples/test/assets/2x_harvest_icon.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_bot_cargo_count] = g_r->load_texture(renderer, "examples/test/assets/drone_cargo_icon.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_player_chain] = g_r->load_texture(renderer, "examples/test/assets/player_chain_icon.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_broken_bot_spawn] = g_r->load_texture(renderer, "examples/test/assets/broken_drone_icon.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_deposit_spawn_rate] = g_r->load_texture(renderer, "examples/test/assets/deposit_spawn.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_deposit_health] = g_r->load_texture(renderer, "examples/test/assets/deposit_yield.png", e_filter_nearest, e_wrap_clamp);
		game->upgrade_button_texture_arr[e_upgrade_dash_cooldown] = g_r->load_texture(renderer, "examples/test/assets/dash_cooldown.png", e_filter_nearest, e_wrap_clamp);

		add_texture(&game->bot_animation, g_r->load_texture(renderer, "examples/test/assets/drone000.png", e_filter_linear, e_wrap_clamp));
		add_texture(&game->bot_animation, g_r->load_texture(renderer, "examples/test/assets/drone006.png", e_filter_linear, e_wrap_clamp));
		add_texture(&game->bot_animation, g_r->load_texture(renderer, "examples/test/assets/drone012.png", e_filter_linear, e_wrap_clamp));
		add_texture(&game->bot_animation, g_r->load_texture(renderer, "examples/test/assets/drone018.png", e_filter_linear, e_wrap_clamp));
		add_texture(&game->bot_animation, g_r->load_texture(renderer, "examples/test/assets/drone024.png", e_filter_linear, e_wrap_clamp));
		game->bot_animation.fps = 12;

		add_texture(&game->ant_animation, g_r->load_texture(renderer, "examples/test/assets/ant000.png", e_filter_linear, e_wrap_clamp));
		add_texture(&game->ant_animation, g_r->load_texture(renderer, "examples/test/assets/ant006.png", e_filter_linear, e_wrap_clamp));
		add_texture(&game->ant_animation, g_r->load_texture(renderer, "examples/test/assets/ant012.png", e_filter_linear, e_wrap_clamp));
		add_texture(&game->ant_animation, g_r->load_texture(renderer, "examples/test/assets/ant018.png", e_filter_linear, e_wrap_clamp));
		add_texture(&game->ant_animation, g_r->load_texture(renderer, "examples/test/assets/ant024.png", e_filter_linear, e_wrap_clamp));
		game->ant_animation.fps = 8;

		add_texture(&game->player_animation, g_r->load_texture(renderer, "examples/test/assets/player000.png", e_filter_linear, e_wrap_clamp));
		add_texture(&game->player_animation, g_r->load_texture(renderer, "examples/test/assets/player006.png", e_filter_linear, e_wrap_clamp));
		add_texture(&game->player_animation, g_r->load_texture(renderer, "examples/test/assets/player012.png", e_filter_linear, e_wrap_clamp));
		add_texture(&game->player_animation, g_r->load_texture(renderer, "examples/test/assets/player018.png", e_filter_linear, e_wrap_clamp));
		add_texture(&game->player_animation, g_r->load_texture(renderer, "examples/test/assets/player024.png", e_filter_linear, e_wrap_clamp));
		game->player_animation.fps = 12;

		game->sound_arr[e_sound_creature_death00] = platform_data->load_sound(platform_data, "examples/test/assets/creature_death00.wav", platform_data->frame_arena);
		game->sound_arr[e_sound_creature_death01] = platform_data->load_sound(platform_data, "examples/test/assets/creature_death01.wav", platform_data->frame_arena);
		game->sound_arr[e_sound_creature_death02] = platform_data->load_sound(platform_data, "examples/test/assets/creature_death02.wav", platform_data->frame_arena);
		game->sound_arr[e_sound_buy_bot] = platform_data->load_sound(platform_data, "examples/test/assets/buy_bot.wav", platform_data->frame_arena);
		game->sound_arr[e_sound_upgrade] = platform_data->load_sound(platform_data, "examples/test/assets/upgrade.wav", platform_data->frame_arena);
		game->sound_arr[e_sound_level_up] = platform_data->load_sound(platform_data, "examples/test/assets/level_up.wav", platform_data->frame_arena);
		game->sound_arr[e_sound_dash] = platform_data->load_sound(platform_data, "examples/test/assets/dash.wav", platform_data->frame_arena);
